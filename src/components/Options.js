        ...
        <tbody>
          {items.map((item, idx) => (
            <tr>
              ...
              <td style={{color: "black"}}>${String(numberWithCommas(item.stock_price))}</td>
              <td style={{color: "black"}}>{item.expiry}</td>
              <td style={{color: "black"}}>${String(numberWithCommas(item.strike))}</td>
              <td style={{color: "black"}}>${String(numberWithCommas(item.ask))}</td>
              <td style={{color: "black"}}>{numberWithCommas(item.units)}</td>
              <td style={{color: "black"}}>${String(numberWithCommas(Math.round(item.invested)))}</td>
              <td
                className={
                  item["profit_0"] < 0
                    ? "bg-danger-subtle"
